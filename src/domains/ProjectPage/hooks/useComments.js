        ...
        try {
            ...
            allComments.forEach(comment => {
                if (comment.parentComment) {
                    const parentId = typeof comment.parentComment === 'object' ? comment.parentComment.id : comment.parentComment;
            ...
            setComments(topLevelComments.filter(comment => !comment.fixed));
        } catch (error) {
